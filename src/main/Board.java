...
public class Board extends JPanel implements KeyListener, MouseListener, MouseMotionListener{
	...
	private BufferedImage blocks, background, pause, restart;
	...
	public Board() {
		...
		blocks = Loader.loadImage("/tiles.png");
		background = Loader.loadImage("/background.png");
		pause = Loader.loadImage("/pause.png");
		restart = Loader.loadImage("/restart.png");
		
		clip = Loader.LoadSound("/music.wav");
		...
		refreshBounds = new Rectangle(350, 500 - restart.getHeight() - 20,restart.getWidth(),
				restart.getHeight() + restart.getHeight()/2);
	...
	public void paintComponent(Graphics g) {
		...
		if (refreshBounds.contains(mouseX, mouseY)) {
			...
			g.drawImage(restart, refreshBounds.x, refreshBounds.y, null);
		}
		...
		g.setFont(new Font("Unispace", Font.PLAIN, 25));
		
		g.drawString("SCORE:", Window.WIDTH - 125, Window.HEIGHT/2);
		g.drawString(score + "", Window.WIDTH - 95, Window.HEIGHT/2 + 50);
		
		g.drawString("NEXT:", Window.WIDTH - 125, Window.HEIGHT - 610);
