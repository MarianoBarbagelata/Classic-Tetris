...
public class Title extends JPanel implements MouseListener, MouseMotionListener {
	...
	public Title(Window window) {
		...
		playButton[0] = play.getSubimage(0, 0, 200, 160);
		playButton[1] = play.getSubimage(200, 0, 200, 160);
		
		bounds = new Rectangle(Window.WIDTH/2 - 100, Window.HEIGHT/2 - 100, 200, 100);
		this.window = window;
	...
	public void paintComponent(Graphics g) {
		...
		if (bounds.contains(mouseX, mouseY)) {
			g.drawImage(playButton[0], Window.WIDTH/2 - 100, Window.HEIGHT/2 - 150, null);
		} else {
			g.drawImage(playButton[1], Window.WIDTH/2 - 100, Window.HEIGHT/2 - 150, null);
		}
